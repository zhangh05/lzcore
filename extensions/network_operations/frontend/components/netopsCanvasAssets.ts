export function netOpsIconForDeviceType(deviceType: string): string {
  ...
  if (type.includes("database") || type.includes("db")) return "/netops-canvas/icons/icon157.png";
  if (type.includes("printer")) return "/netops-canvas/icons/icon159.png";
  if (type.includes("camera")) return "/netops-canvas/icons/icon161.png";
  if (type.includes("phone")) return "/netops-canvas/icons/icon204.png";
  if (type.includes("internet") || type.includes("wan")) return "/netops-canvas/icons/icon205.png";
