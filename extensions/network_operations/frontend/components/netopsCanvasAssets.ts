export function netOpsIconForDeviceType(deviceType: string): string {
  ...
  if (type.includes("camera") || type.includes("video") || type.includes("storage") || type.includes("file") || type.includes("surveillance")) return "/netops-canvas/icons/icon161.svg";
