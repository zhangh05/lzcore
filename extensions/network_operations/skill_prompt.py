...
- A topology node with `manual=true` is a user-drawn diagram symbol, not a registered device. Do not target it with device, inspection, connection, Skill or topology-discovery operations; it can only participate in a user-authored manual drawing link.
